...
<Example resizable padding={false}>
  {
    <Iframe className="h-[572px] w-full overflow-x-scroll">
      <div className="flex h-screen w-screen items-center justify-center p-8">
        <div className="mx-auto max-w-md overflow-hidden rounded-lg bg-white shadow-xl ring-1 ring-gray-900/5 sm:max-w-[42rem]">
...
```html
<!-- [!code word:md\:max-w-[42rem]] -->
<div class="mx-auto max-w-md overflow-hidden rounded-xl bg-white shadow-md md:max-w-[42rem]">
  <!-- [!code word:md\:flex] -->
  <div class="md:flex">
